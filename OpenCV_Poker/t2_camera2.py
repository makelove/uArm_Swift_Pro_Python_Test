...
def draw_line_rectangle(frame):
    ...
    # 左边
    up_left = (int(cols / 2 * 1 / 8), int(rows * 1 / 8))  # 左上点
    down_right = (int(cols / 2 * 7 / 8), int(rows * 7 / 8))  # 右下点
    # print(up_left, down_right)
    cv2.rectangle(frame, up_left, down_right, (0, 255, 0), 3)

    # 右边
    up_left = (int(cols / 2 * 1 / 8 + cols / 2), int(rows * 1 / 8))  # 左上点
    down_right = (int(cols / 2 * 7 / 8 + cols / 2), int(rows * 7 / 8))  # 右下点
    # print(up_left, down_right)
    cv2.rectangle(frame, up_left, down_right, (255, 0, 0), 3)
